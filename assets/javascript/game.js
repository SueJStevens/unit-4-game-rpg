...
"opponentDefeated", "gameOver" ],
    ...
    charactersAll : [ "Name1", "Name2",  "Name3", "Name4", "Name5" , "Name6" , "Name7" , "Name8" , "Name9" ],
    charNumToPlay: 4,
 ...
 */
    ...
    function createPlayerCircle (player, phealth, gameStatusIn) {
        ...
        //construct the the html to append
        str = '<div class="col"> \
                <h2 class="text-left"><strong>Star Character</strong></h2> \
                <div class="row"> \
                    <div class="col-2 text-center"> \
                        <img class="img-responsive d-inline p-1 character" id="playerImg" src="assets/images/PoloroidFrame4.png" alt="' + player +'" value=1 /> \
    ...
    function createBattleField (player, phealth, gameStatusIn, who) {
        ...
        str = '<p>'+who+'</p> \
                    <img class="img-responsive d-inline p-1 ' + who +'" id="'+who+'Img" src="assets/images/PoloroidFrame4.png" alt="' + player +'" value=1 /> \
                        <p class="m-0">' + player + '</p> \
                        <p class="m-0">HP: ' + phealth + '</p> \
                    </div> \
                </div> \
